                ...
                <?php
                 ...
                 <div class="card gedf-card">
                    <div class="card-header">
                     ...
                     <div class="card-body">
                        <div class="text-muted h7 mb-2"> <i class="fa fa-clock-o"></i>'.sanitize_input(date_format(date_create($_SESSION['cheep_date'][$i],timezone_open("America/New_York")),'M d G:i A'));
